...
namespace _2SemesterOpgave.Models
{
    public class Article // Klasse til at repræsentere en artikel, som kan lejes ud på platformen
    {
        ...
        public Article(string title, string description, Size size, float originalPrice, float dailyPrice, Color color, DateTime creationTime, bool isRented, bool isSmoked, bool isAnimal, bool isClean, TrueToSizeEnum trueToSize, ConditionEnum condition, SeasonEnum season, List<ShippingOption> shippingOptions, List<Category> categories, List<SubCategory> subcategories) // Constructor: initialiserer en ny instans af Article-klassen med de angivne parametre
        {
